...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    appTitle: 'bato',
    appSub: 'YOUR PATH TO ENGINEERING',
    tagline: 'Free prep for IOE & KU entrance',
    // hero
    heroTitle1: 'Prepare the',
    heroTitle2: 'Right Way',
    heroSub: 'Free IOE & KU engineering entrance prep — mock tests, past papers, and branch prediction.',
    badgeFree: '🆓 Free',
    badgeMock: '📝 Mock Tests',
    badgePast: '📄 Past Papers',
    badgePredictor: '🎯 Branch Predictor',
    // features
    ...
    mockTags: 'Math • Physics • Chemistry',
    ...
    pastDesc: 'Browse IOE entrance and semester papers by year and subject.',
    pastTag: '2075–2080',
    comingSoon: 'Medical coming soon!',
    footer1: 'bato — free and open source. Contribute on GitHub.',
    footer2: 'Built with ❤️ for Nepal\u2019s future engineers',
  },
  ne: {
    appTitle: 'बाटो',
    appSub: 'इन्जिनियरिङको बाटो',
    tagline: 'IOE र KU प्रवेश परीक्षाको निःशुल्क तयारी',
    // hero
    heroTitle1: 'तयारी हो',
    heroTitle2: 'सही बाटो',
    heroSub: 'निःशुल्क IOE र KU engineering प्रवेश परीक्षाको तयारी — mock test, past papers, र branch prediction।',
    badgeFree: '🆓 निःशुल्क',
    badgeMock: '📝 Mock Tests',
    badgePast: '📄 Past Papers',
    badgePredictor: '🎯 Branch Predictor',
    ...
    mockTags: 'गणित • भौतिक • रसायन',
    predName: 'Branch Predictor',
    predDesc: 'आफ्नो score राख्नुहोस् — past cutoffs को आधारमा कुन IOE branch पाउन सकिन्छ हेर्नुहोस्।',
    predTag: 'IOE Cutoffs',
    pastName: 'Past Papers',
    pastDesc: 'IOE entrance र semester का प्रश्नपत्रहरू year र subject अनुसार।',
    pastTag: '२०७५–२०८०',
    comingSoon: 'Medical चाँडै आउँदैछ!',
    footer1: 'बाटो — निःशुल्क र खुला स्रोत। GitHub मा योगदान गर्नुहोस्।',
    footer2: 'नेपालका भावी इन्जिनियरहरूका लागि ❤️ का साथ',
  },
}
