...
export const medicalCutoffs: MedCutoff[] = [
  ...
  {
    id: 'pahs',
    college: 'Patan Academy of Health Sciences (PAHS), Lagankhel',
    type: 'Government',
    mbbsSeats: 80,
  ...
  {
    id: 'nmc',
    college: 'Nepalgunj Medical College, Nepalgunj',
    type: 'Government',
    mbbsSeats: 100,
  ...
  {
    id: 'birtamod',
    college: 'Provincial Academy of Health Sciences (PAHS), Biratnagar',
    type: 'Government',
    mbbsSeats: 100,
